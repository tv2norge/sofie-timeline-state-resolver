...
import ViscaOverIPActions = require('./$schemas/generated/viscaOverIP/$schemas/actions.json')
import ViscaOverIPOptions = require('./$schemas/generated/viscaOverIP/$schemas/options.json')
import ViscaOverIPMappings = require('./$schemas/generated/viscaOverIP/$schemas/mappings.json')
