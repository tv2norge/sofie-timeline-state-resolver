...
export interface ResolvedTimelineObjectInstanceKeyframe<TContent = unknown> extends ResolvedTimelineObjectInstance<TContent> {
    isKeyframe?: boolean;
...
//# sourceMappingURL=superfly-timeline.d.ts.map